...
function Header() {
  return (
    <>
      <div className="h-screen bg-cream" style={{ marginTop: '100px' }}>
        <div className="max-w-screen-xl px-8 mx-auto flex flex-col lg:flex-row items-start">
          ...
          <div className="flex flex-col w-full lg:w-6/12 justify-center lg:pt-24 items-start text-center lg:text-left mb-5 md:mb-0">
            ...
            <p data-aos="fade-down" data-aos-once="true" data-aos-delay="300" className="leading-normal text-2xl mb-8">Skilline is an interesting platform that will teach you in a more interactive way</p>
          ...
          {/* Image Div */}
          <div className="w-full lg:w-6/12 lg:-mt-30 relative flex justify-end " id="girl" style={{ marginRight: '100px' }}>
            ...
            <img src={mainPicture} alt="mainPicture" style={{ width: '100%', height: 'auto',marginTop: '100px',marginLeft: '100px',position: 'relative',zIndex:"-4"}} />
      ...
      <section className="bg-[#b284be] h-screen flex px-[10%] py-[6%]">
        <div className="mt-15">
          ...
          <div data-aos="fade-up" className="flex flex-col md:flex-row justify-center space-y-5 md:space-y-0 md:space-x-6 lg:space-x-10 mt-7">
            ...
            <div className="relative md:w-5/12">
              <img className="rounded-2xl" src={student} alt="" />
              <div className="absolute bg-black bg-opacity-20 bottom-0 left-0 right-0 w-full h-full rounded-2xl">
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
      ...
      <section className="bg-[#f3f5f5] h-100 flex px-[10%] py-[6%]">
        <div className="h-40 w-full overflow-hidden">
          <div id="scroll-slider" className="animate-slide-right flex w-96 p-4">
            <div className="m-4 h-40 w-64 flex-shrink-0 rounded-lg border bg-gray-300 p-4">
              <h2 className="text-lg font-semibold">Course Title 1</h2>
              <p className="text-sm text-gray-500">Course Description 1</p>
              <button className="text-blue-500">Enroll</button>
            </div>
            <div className="m-4 h-40 w-64 flex-shrink-0 rounded-lg border bg-gray-300 p-4">
              <h2 className="text-lg font-semibold">Course Title 2</h2>
              <p className="text-sm text-gray-500">Course Description 2</p>
              <button className="text-blue-500">Enroll</button>
            </div>
          </div>
        </div>
